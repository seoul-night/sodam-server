...
public class WebmvcConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(authorizationInterceptor)
                .addPathPatterns("/**")
                .excludePathPatterns("/members/kakao/login","/members/kakao/oauth","/members/kakao/login/test","/members/kakao/oauth/test","/members/search/**","/members/walks/search/complete/**","/walks/**");
